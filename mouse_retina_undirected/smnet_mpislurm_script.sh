...
#SBATCH --job-name="SMNet_mpi_mouse_retina"
#SBATCH --ntasks=20
#SBATCH -p slim
...
time Rscript $HOME/Snowball/USI/scripts/plotSMNetParameters.R
time Rscript $HOME/Snowball/USI/scripts/plotSMNetStats.R
