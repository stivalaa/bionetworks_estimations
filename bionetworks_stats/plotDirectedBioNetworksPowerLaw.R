#!/usr/bin/Rscript
#
# File:    plotDirectedBioNetworksPowerLaw.R
# Author:  Alex Stivala
# Created: March 2017
#
...
descrs <- c(
    ...
    expression('Gerstein'~~italic('E. coli')~~'regulatory'),
    expression('Alon yeast regulatory'),
    expression('Gerstein yeast regulatory'),
...
outfile <- "directed_bionetworks_powerlaw.eps"
