#!/usr/bin/Rscript
#
# File:    plotKaiserCelegans277PowerLawPowerLaw.R
# Author:  Alex Stivala
# Created: July 2023
#
...
#
# Usage: Rscript plotKaiserCelegans277PowerLawPowerLaw.R 
#
...
if (length(args) != 0) {
  cat("Usage: plotKaiserCelegans277PowerLawPowerLaw\n")
  quit(save="no")
}
datadir <- args[1]

outfile <- "KaiserCelegans277PowerLaw_powerlaw.eps"
