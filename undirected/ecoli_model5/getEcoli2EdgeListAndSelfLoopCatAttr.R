#!/usr/bin/Rscript
#
# File:    getEcol2EdgeListAndSelfLoopCatAttr.R
# Author:  Alex Stivala
# Created: March 2017
#
...
# This version also gets the self-loop node attribute as a categorical attribute.
#
# Usage:
# 
# Rscript getEcoli2EdgeListAndSelfLoopCatAttr.R 
#
...
#
write_subactors_file_with_cat_attr <- function(filename, g) {
...
write.graph(g, edgelistfilename, format="pajek")
write_subactors_file_with_cat_attr(actorsfilename, g)
