#!/usr/bin/Rscript
#
# File:    getYeastEdgeListWithAttrRemoveIsolatedDyads.R
# Author:  Alex Stivala
...
#
# This version removes isolated dyads (nodes with degree 1)
#
# Usage:
# 
# Rscript getYeastEdgeListWithAttrRemoveIsolatedDyads.R 
#
