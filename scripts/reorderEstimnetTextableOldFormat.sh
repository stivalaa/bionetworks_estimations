...
# assume older format of input latex table from estimnetdirectedEstimation2textableMultiModels.sh
# 7 header rows and only 2 trailer rows (no converged, total runs)
headrows=7
tailrows=2
