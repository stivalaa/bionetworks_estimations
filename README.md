# Data and scripts for "Testing biological network motif significance with exponential random graph models" and "New network models facilitate biological network motif statistical significance testing"
